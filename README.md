...
![Public API Request Flow](https://github.com/manhtd98/go-template/blob/main/assets/go-arch-public-api-request-flow.png?raw=true)

### Private API Request Flow with JWT Authentication Middleware

> JWT Authentication Middleware for Access Token Validation.

![Private API Request Flow](https://github.com/manhtd98/go-template/blob/main/assets/go-arch-private-api-request-flow.png?raw=true)
